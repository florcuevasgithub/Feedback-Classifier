...
if RENDER_FREE_MODE or DISABLE_ML_MODELS or ML_FALLBACK_MODE:
    ...
    # Modo completo con transformers
    print("[ML_Pipeline] Cargando especialistas COMPLETOS...")
    try:
        from sentimiento import classify_sentiment
        from urgencia import classify_urgency  
        from categoria import classify_category
        print("[ML_Pipeline] ✅ Especialistas COMPLETOS cargados")
...
def analyze_feedback(text: str) -> dict:
    ...
    try:
        ...
        final_analysis = {
            ...
            "mode": "lite" if (RENDER_FREE_MODE or DISABLE_ML_MODELS) else "full"
        }
